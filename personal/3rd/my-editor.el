...
(defun my-switch-to-code-root ()
  (interactive)
  (cond ((file-directory-p "/face/fzhou/code")
         (find-file "/face/fzhou/code"))
        ((file-directory-p "/data/algorithm/user/fzhou")
         (find-file "/data/algorithm/user/fzhou"))
        ((file-directory-p "/Users/feng/code")
         (find-file "/Users/feng/code"))
        ((file-directory-p "/home/feng/code")
         (find-file "/home/feng/code"))
        ((file-directory-p "/root/code")
         (find-file "/root/code"))))

;; switch to data root depending on machine
(defun my-switch-to-data-root ()
  (interactive)
  (cond ((file-directory-p "/face/fzhou/parking/data")
         (find-file "/face/fzhou/parking/data"))
        ((file-directory-p "/data/parkinglot")
         (find-file "/data/parkinglot"))
        ((file-directory-p "/data/algorithm")
         (find-file "/data/algorithm"))
        ((file-directory-p "/Users/feng/data")
         (find-file "/Users/feng/data"))
        ((file-directory-p "/home/feng/data")
         (find-file "/home/feng/data"))
        ((file-directory-p "/root/data")
         (find-file "/root/data"))))
